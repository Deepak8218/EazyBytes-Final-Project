        ...
        <div className="Event" key={event._id}>
            ...
            <div className="Events">
                ...
                <div className="que-ans">
                    <span className="que">What is the name of the event?</span>
                    <p className="name">{event.name}</p>
                    <span className="que">Where will the event be held?</span>
                    <p className="location">{event.location}</p>
                    <span className="que">When will the event be held?</span>
                    <p className="date">{event.date}</p>
                    <span className="que">What is the event about?</span>
